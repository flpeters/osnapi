...
__all__ = ['Settings', 'login', 'getSensors', 'getSensor', 'addSensor', 'deleteSensor', 'mySensors', 'mySensorIds',
           'getFirstLastValueForSensor', 'getValues', 'getValuesForSensor', 'addValue', 'addMultipleValues', 'profile',
           'getMeasurands', 'getMeasurand', 'getLicenses', 'getLicense', 'getUnits', 'getUnit']
